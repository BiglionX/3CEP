    ...
    },
{
  ...
  const companyAddresses = [
    {
      city: '北京总部',
      address: '北京市朝阳区建国路8号现代城A501',
      phone: '010-88889999'
    },
    {
      city: '上海分公司',
      address: '上海市浦东新区陆家嘴环路1000号恒生大厦808',
      phone: '021-66668888'
    },
    {
      city: '广州办事处',
      address: '广州市天河区珠江新城华夏路10号富力中心205室',
      phone: '020-77776666'
    },
    {
      city: '深圳研发中心',
      address: '深圳市南山区科技园南区高新南一道01室',
      phone: '0755-55553333'
    }
  ]
            ...
            <CardContent>
              {submitSuccess ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">我们已收到您的留言，将在4小时内回复您</p>
                </div>
              ) : (
