            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-gray-700">
                    <strong>半径筛选</strong> - 自定义搜索范围（公里）
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-gray-700">
                    <strong>智能排序</strong> - 按距离自动排序
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-gray-700">
                    <strong>多平台支持</strong> - JavaScript &amp; Python
                  </span>
                </li>
              </ul>
            </section>
...
// TODO: 移除调试日志 - console.log(result.data.shops)`}
                    </pre>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">13 个</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">代码覆盖率</span>
