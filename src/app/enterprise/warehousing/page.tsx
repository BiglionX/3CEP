      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            全球仓储网络和智能物流管理，实现库存同步、智能分仓和高效配送
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">覆盖5个国家</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">在途货物</CardTitle>
                  <Truck className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">1,247</div>
                  <p className="text-xs text-muted-foreground">预计24小时内到达</p>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <div className="font-medium">德国汉堡仓</div>
                          <div className="text-sm text-gray-600">Hamburg, Germany</div>
                        </div>
                        <div className="text-right">
                          <div className="text-sm font-medium">筹备中</div>
                          <div className="text-xs text-gray-500">即将开业</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-left py-3 px-4">利用率</th>
                    ...
                    <tbody>
                      {warehouses.map((warehouse) => (
                        <tr key={warehouse.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">{warehouse.currentStock.toLocaleString()}</td>
                          ...
                          <td className="py-3 px-4">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(warehouse.status)}`}>
                              {warehouse.status === 'active' && '运营中'}
                              {warehouse.status === 'maintenance' && '维护中'}
                              {warehouse.status === 'full' && '已满载'}
                            </span>
                          </td>
                        </tr>
                      ))}
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-left py-3 px-4">承运商</th>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span>库存周转率</span>
                      <span className="font-semibold">8.1次/年</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>滞销商品占比</span>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span>仓储成本节省</span>
                      <span className="font-semibold text-green-600">¥1,240,000</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>配送效率提升</span>
