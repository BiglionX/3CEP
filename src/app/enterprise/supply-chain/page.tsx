      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          <nav className="-mb-px flex space-x-8">
            {['dashboard', 'suppliers', 'inventory', 'demand-forecast'].map(
              tab => (
                <button
                  key={tab}
                  ...
                  {suppliers.map(supplier => (
                    <div key={supplier.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs ${getStatusColor(supplier.status)}`}
                        >
                      ...
                      {inventoryItems.map(item => (
                        <tr key={item.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span
                              className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getInventoryStatusColor(item.status)}`}
                            >
