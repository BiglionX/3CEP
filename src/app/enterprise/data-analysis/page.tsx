      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            AI驱动的数据分析和商业洞察平台，提供数据可视化、预测分析和异常检测功能
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">指标类型</label>
                    ...
                    <tbody>
                      {reports.map((report) => (
                        <tr key={report.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">{report.nextSchedule || '-'}</td>
                          <td className="py-3 px-4">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="p-4 bg-blue-50 rounded-lg">
                      <h3 className="font-semibold text-blue-900 mb-2">下月销售预测</h3>
                      <p className="text-blue-700">
                        预计下月销售额将达到 ¥1,380,000，同比增长 15.2%
                      </p>
                    </div>
                    <div className="p-4 bg-green-50 rounded-lg">
                      <h3 className="font-semibold text-green-900 mb-2">热门产品预测</h3>
                      <p className="text-green-700">
                        根据趋势分析，智能家居产品线预计将增长 25%
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-yellow-50 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <h3 className="font-semibold text-yellow-900">库存预警</h3>
                      </div>
                      <p className="text-yellow-700">
                        产品 XYZ-2024 的库存低于安全线，建议及时补货
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="font-semibold text-red-900">服务器负载过高</h3>
                        <p className="text-red-700 text-sm">CPU 使用率达到 95%，建议扩容</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-red-600">2分钟前</div>
                      <Button variant="outline" size="sm" className="mt-1">处理</Button>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="font-semibold text-yellow-900">库存不足预警</h3>
                        <p className="text-yellow-700 text-sm">产品 ABC-123 库存仅剩 15 件</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-yellow-600">15分钟前</div>
                      <Button variant="outline" size="sm" className="mt-1">查看详情</Button>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="font-semibold text-green-900">系统恢复正常</h3>
                        <p className="text-green-700 text-sm">数据库连接已恢复稳定状态</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-green-600">1小时前</div>
                      <Button variant="outline" size="sm" className="mt-1">确认</Button>
                    </div>
                  </div>
                </div>
              </CardContent>
