...
export default function EnterpriseServicePage() {
  ...
  const enterpriseServices: EnterpriseService[] = [
    ...
    },
    {
      ...
      icon: ShoppingCart,
      features: ['智能需求解析', '供应商匹配', '自动询价', '风险评估'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {enterpriseServices.map((service) => {
                  ...
                  return (
                    <Card key={service.id} className="shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                      <CardHeader>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">智能化效率</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">全球化服务</h3>
                  <p className="text-gray-600">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">数据驱动决策</h3>
                  <p className="text-gray-600">
        ...
        {activeTab === 'solutions' && (
          <div className="text-center py-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">行业解决方案</h2>
            <p className="text-xl text-gray-600 mb-12">针对不同行业提供定制化AI解决方案</p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: '制造业', desc: '智能制造、供应链优化、质量管控' },
                { title: '贸易商', desc: '进出口管理、订单跟踪、合作伙伴关系' },
                ...
                <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <Button variant="outline" className="mt-4" onClick={() => {
                      if (solution.title === '贸易商') {
                        window.location.href = '/foreign-trade/company';
                      }
                    }}>
                      {solution.title === '贸易商' ? '进入管理平台' : '查看详情'}
                    </Button>
                  </CardContent>
                </Card>
              ))}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-50 rounded-xl p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">联系我们</h3>
