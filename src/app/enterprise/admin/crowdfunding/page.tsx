...
export default function CrowdfundingManagementPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusMap: Record<string, { text: string; color: string }> = {
      ...
      active: { text: '筹集中', color: 'bg-blue-100 text-blue-800' },
                  ...
                  <tr key={project.id} className="border-b hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div 
                            ...
                            style={{ width: `${Math.min(project.funding_progress, 100)}%` }}
                          ></div>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium">{project.supporters_count}</span>
                      </div>
                    </td>
                    <td className="py-4 px-4">
