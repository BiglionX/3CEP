...
export default function EnterpriseAgentsPage() {
  ...
  const getTypeConfig = (type: string) => {
    switch (type) {
      case 'customer-service': return { label: '客户服务', color: 'bg-blue-100 text-blue-800' };
      case 'data-analysis': return { label: '数据分析', color: 'bg-green-100 text-green-800' };
      case 'procurement': return { label: '采购管理', color: 'bg-purple-100 text-purple-800' };
      case 'workflow': return { label: '流程自动化', color: 'bg-orange-100 text-orange-800' };
  ...
  const getStatusConfig = (status: string) => {
    switch (status) {
      ...
      default: return { label: status, color: 'bg-gray-100 text-gray-800', icon: XCircle };
    }
  };
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">总智能体数</p>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                              ...
                              <p className={`font-semibold ${agent.successRate >= 95 ? 'text-green-600' : agent.successRate >= 90 ? 'text-yellow-600' : 'text-red-600'}`}>
                                {agent.successRate}%
                              </p>
                            </div>
                            <div>
          ...
          {filteredAgents.length === 0 && (
            <Card>
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">未找到匹配的智能体</h3>
                <p className="text-gray-500 mb-4">尝试调整搜索条件或创建新的智能体</p>
                <Button>
                  <Plus className="w-4 h-4 mr-2" />
                  创建智能体
                </Button>
