...
export default function EnterpriseTokensPage() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-700">3,800</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-700">45,200</div>
              <div className="flex items-center text-xs text-green-600 mt-1">
                <TrendingUp className="w-3 h-3 mr-1" />
                +8% 较上月
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-700">1,507</div>
