...
const TestComponentDemo = () => {
  ...
  const testCases = [
    ...
    },
    {
      id: 'tc-002',
      name: '预约时间冲突处理测试',
      description: '测试多个用户预约同一时间段时的冲突处理机制'
    },
    {
      id: 'tc-003',
      name: '连续时间段预约测试',
    ...
    },
    {
      id: 'tc-004',
      name: '点赞功能边界测试',
      description: '测试点赞次数限制和重复点击防护'
    },
    {
      id: 'tc-005',
      name: '文件上传大小限制测试',
      description: '验证文件上传的大小限制和格式检查'
    }
  ];
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant="secondary">
              {testResults.filter(r => r.status === 'passed').length}/{testCases.length} 通过
            </Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
