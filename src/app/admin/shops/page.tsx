                ...
                <TableRow key={shop.id} className="border-b">
                  ...
                  <TableCell>
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-xs text-gray-500">
                        ({shop.review_count || 0}条评价)
                      </span>
                    </div>
                  </TableCell>
                  <TableCell>{getStatusBadge(shop.status)}</TableCell>
                  <TableCell>{formatDate(shop.updated_at)}</TableCell>
                  <TableCell className="text-right">
                    <div className="flex gap-2 justify-end">
                      ...
                      <Button
                        variant={
                          shop.status === 'approved' ? 'outline' : 'default'
                        }
                        size="sm"
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={e =>
                    setEditingShop({ ...editingShop, services: e.target.value })
                  }
                  rows={3}
          ...
          <DialogFooter>
            ...
            <Button onClick={saveShopEdit}>保存更改</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
