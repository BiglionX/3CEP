  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600">展示基于角色的界面元素动态显示控制</p>
      </div>

      {/* 角色切换器 */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold mb-4">角色模拟器</h2>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <PermissionControl role={['admin', 'manager']} className="mt-4">
            <div className="border rounded-lg p-4 bg-purple-50">
              ...
              <p className="text-purple-600 text-sm">仅管理员和经理角色可见</p>
            </div>
          </PermissionControl>
        </div>
      </div>
            ...
            fallback={
              <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <span className="text-red-700">仅管理员可见的内容区域</span>
                </div>
              </div>
            }
          >
          ...
          <PermissionGuard
            ...
            fallback={
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <span className="text-yellow-700">您没有内容管理权限</span>
              </div>
            }
          >
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <span className="text-blue-700 font-medium">内容创作工作室</span>
              <p className="mt-1 text-blue-600 text-sm">
                欢迎进入内容创作空间，您可以在这里创建和编辑精彩内容。
              </p>
            </div>
          </PermissionGuard>
        </div>
