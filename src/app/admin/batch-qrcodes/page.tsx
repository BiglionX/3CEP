...
import { Download, Upload, QrCode, Package, AlertCircle, CheckCircle, Clock } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {batches.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500 mb-6">开始创建您的第一个批量二维码生成任务</p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 border-t border-gray-200 flex justify-end space-x-4">
                ...
                <button
                  onClick={createBatch}
                  disabled={!formData.productModel || !formData.productCategory || !formData.brandId || !formData.productName}
