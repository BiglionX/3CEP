...
export default function ForeignTradePortalPage() {
  const [portalSettings, setPortalSettings] = useState({
    name: '我的外贸门户',
    description: '专业的国际贸易服务',
    logo: '',
    favicon: '',
    themeColor: '#2563eb',
  });
  ...
  const [businessLinks, setBusinessLinks] = useState([
    { id: '1', name: '公司官网', url: 'https://example.com' },
    { id: '2', name: '产品目录', url: 'https://products.example.com' },
    { id: '3', name: '合作咨询', url: 'https://partners.example.com' },
  ]);
  ...
  const [promotionalImages] = useState<PromotionalImage[]>([
    { id: '1', url: '/images/promo1.jpg', title: '全球贸易网络', order: 1 },
    { id: '2', url: '/images/promo2.jpg', title: '优质产品', order: 2 },
    { id: '3', url: '/images/promo3.jpg', title: '合作伙伴', order: 3 },
  ]);
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">您的门户地址：</span>
                <span className="text-sm font-mono text-blue-700">
                  https://portal.example.com/foreign-trade/your-portal
                </span>
              </div>
              <Button
                variant="outline"
