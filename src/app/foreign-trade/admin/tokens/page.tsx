...
export default function ForeignTradeTokensPage() {
      ...
      <div className="max-w-7xl mx-auto">
                  ...
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-blue-500">
                    <CardContent className="p-4">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-600 mb-2">Token</div>
                  ...
                  <div className="text-right">
                    <div
                      className={`text-xl font-bold ${
                        record.amount > 0 ? 'text-green-600' : 'text-blue-600'
                      }`}
                    >
                      {record.amount > 0 ? '+' : ''}
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-700">5,200</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-700">62,800</div>
              <div className="flex items-center text-xs text-green-600 mt-1">
                <TrendingUp className="w-3 h-3 mr-1" />
                +12% 较上月
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-700">2,093</div>
