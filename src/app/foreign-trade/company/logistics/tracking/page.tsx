...
export default function LogisticsTrackingPage() {
  ...
  const getStatusInfo = (status: string) => {
    const statusMap: Record<string, { text: string; color: string; icon: React.ReactNode }> = {
      ...
      in_transit: { text: '运输中', color: 'bg-purple-100 text-purple-800', icon: <Truck className="h-4 w-4" /> },
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-1">发货单号</h3>
                      <p className="text-lg text-gray-900">{trackingInfo.shipmentNumber}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-1">运输方式</h3>
                      <p className="text-lg text-gray-900">{getTransportText(trackingInfo.transportMode)}</p>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-1">重量</h3>
                      <p className="text-lg text-gray-900">{trackingInfo.shipmentInfo.weight} kg</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-1">体积</h3>
                      <p className="text-lg text-gray-900">{trackingInfo.shipmentInfo.volume} m³</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-1">件数</h3>
                      <p className="text-lg text-gray-900">{trackingInfo.shipmentInfo.packages} 件</p>
                    </div>
                    <div>
                  ...
                  {(trackingInfo.shipmentInfo.containerNumber || 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 pt-6 border-t">
                      {trackingInfo.shipmentInfo.containerNumber && (
                        <div>
                          <h3 className="text-sm font-medium text-gray-500 mb-1">集装箱号</h3>
                          <p className="text-gray-900 font-mono">{trackingInfo.shipmentInfo.containerNumber}</p>
                        </div>
                      )}
                      {trackingInfo.shipmentInfo.vesselName && (
                        <div>
                          <h3 className="text-sm font-medium text-gray-500 mb-1">船名/航班</h3>
                          <p className="text-gray-900">{trackingInfo.shipmentInfo.vesselName}</p>
                        </div>
                      )}
                      {trackingInfo.shipmentInfo.flightNumber && (
                        <div>
                          <h3 className="text-sm font-medium text-gray-500 mb-1">航班号</h3>
                          <p className="text-gray-900 font-mono">{trackingInfo.shipmentInfo.flightNumber}</p>
                        </div>
                      )}
                    </div>
                  )}
            ...
            <Card>
              <CardContent className="py-12">
                <div className="text-center">
                  ...
                  <h3 className="mt-2 text-lg font-medium text-gray-900">未找到物流信息</h3>
