  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">产品说明书</h1>
