  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">FCX等级展示组件测试</h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* 青铜级示例 */}
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">青铜级用户</h2>
            <FcxLevelDisplay 
          ...
          {/* 白银级示例 */}
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">白银级用户</h2>
            <FcxLevelDisplay 
          ...
          {/* 黄金级示例 */}
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">黄金级用户</h2>
            <FcxLevelDisplay 
          ...
          {/* 钻石级示例 */}
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">钻石级用户</h2>
            <FcxLevelDisplay 
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong>评分占比 30%：</strong>客户评价平均分</li>
              <li><strong>完成率占比 25%：</strong>订单完成比例</li>
              <li><strong>订单数量占比 20%：</strong>累计完成订单数</li>
              <li><strong>服务质量占比 15%：</strong>服务质量和专业度</li>
              <li><strong>FCX2余额占比 10%：</strong>持有的FCX2期权数量</li>
            </ul>
          </div>
        </div>
      </div>
