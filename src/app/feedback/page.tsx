  ...
  const [feedbacks, setFeedbacks] = useState<Feedback[]>([
    {
      id: '1',
      user: '张三',
      message: '希望能在维修记录中添加图片上传功能，这样可以更好地记录维修过程。',
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={option.value}
                    onClick={() => setNewFeedback({...newFeedback, category: option.value as any})}
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-3">support@fixcycle.com</p>
