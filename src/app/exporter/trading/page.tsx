...
export default function TradingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 px:6lg:px-8 py-8">
        {/* 搜索和筛选区域 */}
        <Card className="mb-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>管理所有出口销售订单的状态和进度</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {filteredOrders.length === 0 ? (
                ...
                filteredOrders.map(order => (
                  <div
                    key={order.id}
                    className="border border-gray-200 rounded-lg p-4 bg-gray-50 transition-colors cursor-pointer"
