...
export default function UserOrdersPage() {
  ...
  const getPriorityInfo = (priority: string) => {
    switch (priority) {
      case 'low': return { text: '低', color: 'text-gray-500' }
      case 'medium': return { text: '中', color: 'text-blue-500' }
      case 'high': return { text: '高', color: 'text-orange-500' }
      case 'urgent': return { text: '紧急', color: 'text-red-500' }
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div className="flex items-center text-gray-600">
                        ...
                        <div>
                          <p>创建时间: {new Date(order.createTime).toLocaleDateString()}</p>
                          <p className="text-gray-500">
                            预计完成: {new Date(order.estimatedCompletion).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
