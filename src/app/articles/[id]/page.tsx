    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-1 text-gray-500">抱歉，您访问的文章不存在或已被删除</p>
          <div className="mt-6">
            <Link
              href="/articles"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/articles" className="text-xl font-bold text-gray-900">
                FixCycle 知识库
              </Link>
            </div>
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 pb-6 border-b border-gray-200">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <svg className="w-4 h-4 mr-1" fill={liked ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 20 20">
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      <span>{related.article_categories?.name}</span>
                      <span>
