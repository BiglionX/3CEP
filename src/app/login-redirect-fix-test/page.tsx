...
export default function LoginRedirectFixTest() {
  ...
  // 初始化调试信?  useEffect(() => {
    ...
    // TODO: 移除调试日志 - // TODO: 移除调试日志 - console.log('🔍 调试信息:', {
      url,
      search,
      params,
      redirectValue: redirect,
  ...
  const runRedirectTest = () => {
    ...
    // 测试2: SearchParams Hook检?    const hookTest = {
      feature: 'SearchParams Hook检?,
  ...
  const testLoginJump = () => {
    ...
    // TODO: 移除调试日志 - // TODO: 移除调试日志 - console.log('跳转到登录页?', loginUrl)router.push(loginUrl);
  };
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-blue-600">{debugInfo.search || '(�?'}</p>
                </div>
                <div>
                  <p className="font-medium text-blue-700">redirect�?</p>
                  <p className="text-blue-600">{debugInfo.redirectValue}</p>
                </div>
                <div>
                  <p className="font-medium text-blue-700">所有参?</p>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <div className="flex flex-wrap gap-3">
                <Button onClick={runRedirectTest}>运行重定向检测测?/Button>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="text-sm text-gray-600">快速测试链?</span>
                <Button
                  size="sm"
                  variant="ghost"
            ...
            <div className="bg-yellow-50 p-5 rounded-lg border border-yellow-200">
              ...
              <div className="space-y-3 text-sm text-yellow-700">
                <div>
                  <p className="font-medium">常见问题及解决方?</p>
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    ...
                    <li>
                      <strong>浏览器缓存问?</strong> 尝试刷新页面或清除缓?                    </li>
                  </ul>
                </div>
