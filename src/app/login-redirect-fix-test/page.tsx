        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-800 mb-3">📊 当前页面调试信息</h3>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="font-semibold text-gray-800 mb-4">🧪 测试控制面板</h3>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <Button 
                  size="sm" 
                  variant="ghost"
                  onClick={() => router.push('/login-redirect-fix-test?redirect=/admin/dashboard')}
                >
                  管理后台
                </Button>
                <Button 
                  size="sm" 
                  variant="ghost"
                  onClick={() => router.push('/login-redirect-fix-test?redirect=/profile')}
                >
                  用户页面
                </Button>
              </div>
                ...
                {testResults.map((result, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-gray-800">{result.feature}</span>
            ...
            <div className="bg-yellow-50 p-5 rounded-lg border border-yellow-200">
              <h3 className="font-semibold text-yellow-800 mb-3">💡 问题诊断和解决方案</h3>
              <div className="space-y-3 text-sm text-yellow-700">
                <div>
                  <p className="font-medium">常见问题及解决方案:</p>
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li><strong>URL中确实没有redirect参数:</strong> 这是正常情况，系统会使用默认值</li>
                    <li><strong>Hook无法获取参数:</strong> 检查useSearchParams是否正确导入</li>
                    <li><strong>参数解析错误:</strong> 确认URL编码是否正确</li>
                    <li><strong>浏览器缓存问题:</strong> 尝试刷新页面或清除缓存</li>
                  </ul>
                </div>
