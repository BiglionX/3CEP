...
// 牸棰勬祴澶勭悊async function handlePricePrediction(params: any) {
...
// 鎵归噺棰勬祴澶勭悊async function handleBatchPrediction(params: any) {
...
// 棰勬祴鍘嗗彶澶勭悊async function handlePredictionHistory(searchParams: URLSearchParams) {
  try {
...
// 妯″瀷鍒楄〃澶勭悊async function handleModelList() {
  return NextResponse.json({
    success: true,
    data: {
      demandModels: [
        {
          ...
          name: 'DeepSeek Chat',
          type: 'demand',
          description: '傜敤浜庨渶姹傞娴嬬殑澶ц瑷€妯″瀷',
          capabilities: ['堕棿搴忓垪鍒嗘瀽', '瓒嬪娍棰勬祴', '瀛ｈ妭鎬у垎],
        },
        {
          id: 'local-arima',
          name: '鏈湴ARIMA',
          type: 'demand',
          description: '犵粺缁熻瀛﹂娴嬫ā鍨嬶紙闄嶇骇鏂规,
      ...
      priceModels: [
        {
          ...
          name: 'DeepSeek Chat',
          type: 'price',
          description: '傜敤浜庝环鏍奸娴嬬殑澶ц瑷€妯″瀷',
          capabilities: ['牸瓒嬪娍鍒嗘瀽', '绔炰簤鍒嗘瀽', '甯傚満娲炲療'],
        },
        {
          id: 'local-prophet',
          name: '鏈湴Prophet',
          type: 'price',
          description: 'Facebook寮€婧愮殑堕棿搴忓垪棰勬祴宸ュ叿锛堥檷绾ф柟妗堬級',
          capabilities: ['牸瓒嬪娍棰勬祴', '鑺傚亣ユ晥],
        },
      ],
    },
    timestamp: new Date().toISOString(),
