...
export default function AboutPage() {
  const companyStats = [
    ...
    { label: '技术专利', value: '23+', icon: Award },
  ...
  const milestones = [
    {
      year: '2020',
      title: '公司成立',
      description: 'FixCycle正式成立，专注智能设备维修服务',
      achievement: '获得天使轮融资1000万'
    },
    {
      year: '2021',
      title: '服务网络扩展',
      description: '建立覆盖全国主要城市的维修服务网络',
      achievement: '服务城市达到50个'
    },
    {
      year: '2022',
      title: '技术创新突破',
      description: '推出AI智能诊断系统，提升维修效率',
      achievement: '获得国家发明专利5项'
    },
    {
      year: '2023',
      title: '平台生态完善',
      description: '构建完整的设备生命周期管理平台',
      achievement: '用户突破10万，月订单量超5000单'
    },
    {
      year: '2024',
      title: '行业领先地位',
      description: '成为国内领先的智能设备维修服务平台',
      achievement: '完成B轮融资5000万，估值达5亿'
    },
    {
      year: '2025',
      title: '国际化布局',
