...
export const opsContent = {
  ...
  features: [
    {
      title: "异常自动识别与处理",
      description: "基于AI的异常检测引擎，自动识别订单异常类型并执行标准化处理流程，减少人工干预85%",
      metrics: ["异常识别准确率99%", "处理时效提升70%", "人工成本降低60%"],
      icon: "alert-triangle"
    },
    {
      title: "工单智能分派",
      description: "根据技能标签和负载情况，智能分配工单给最合适的处理人员，提升处理效率40%",
      metrics: ["分派准确率95%", "响应时间缩短50%", "满意度提升30%"],
      icon: "users"
    },
    {
      title: "SLA实时监控",
      description: "全链路SLA监控预警系统，提前发现潜在超时风险并自动触发补救措施",
      metrics: ["预警准确率90%", "超时率降低80%", "客户投诉减少70%"],
      icon: "clock"
    },
    {
      title: "多渠道统一管理",
      description: "整合电话、微信、邮件等多渠道客服入口，统一工单池管理，避免遗漏",
  ...
  testimonials: [
    {
      quote: "引入自动化异常处理后，我们的客服响应效率提升了60%，客户满意度显著改善。",
      author: "张明华",
      position: "客服总监",
      company: "某知名电商平台",
      rating: 5
  ...
  faqs: [
    {
      ...
      answer: "我们采用机器学习算法，结合历史数据训练模型，识别准确率达到99%。同时支持人工复核机制，确保关键业务不受影响。"
    },
    {
      question: "系统能否与现有客服系统集成？",
      answer: "支持。我们提供标准API接口，可与主流客服系统（如Zendesk、网易七鱼等）无缝集成。"
    }
  ]
};
...
export const techContent = {
  ...
  features: [
    {
      title: "可视化工作流编排",
      description: "基于n8n的拖拽式工作流设计器，零代码实现复杂的系统集成和自动化运维任务",
  ...
  faqs: [
    {
      ...
      answer: "很低。n8n采用可视化拖拽界面，基本无需编程基础即可上手。我们还提供详细的文档和培训支持。"
    },
    {
      question: "如何保障生产环境的安全性？",
      answer: "提供完善的权限管控、执行审批、沙箱测试等安全机制，确保变更操作可控可追溯。"
    }
  ]
};
...
export const bizContent = {
  ...
  features: [
    {
      title: "ROI智能计算器",
      description: "基于历史数据和行业基准，精准预测自动化投入产出比，为决策提供量化依据",
    ...
    {
      title: "合规与安全保障",
      description: "符合GDPR、网络安全法等法规要求，完善的数据保护和隐私安全机制",
  ...
  faqs: [
    {
      ...
      answer: "根据我们的统计数据，大多数客户在3-6个月内实现正向ROI，一年内投资回报率可达300%以上。"
    },
    {
      question: "是否有成功案例可供参考？",
      answer: "我们在电商、制造、金融等多个行业都有成功案例，可以安排实地考察或线上分享会。"
    }
  ]
};
...
export const partnerContent = {
  ...
  features: [
    ...
    {
      title: "标准化数据接口",
      description: "提供完善的API文档和SDK，支持订单、库存、财务等核心数据实时同步",
  ...
  faqs: [
    {
      question: "入驻需要什么资质要求？",
      answer: "需要营业执照、相关行业许可证，以及一定的服务能力。具体要求可在申请时查看详细说明。"
    },
    {
      question: "技术服务支持如何？",
      answer: "提供7×24小时技术支持热线、在线客服、技术文档、定期培训等多种支持方式。"
    }
  ]
};
