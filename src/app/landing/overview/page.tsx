...
export default function OverviewPage() {
  ...
  const features = [
    {
      ...
      metrics: ['支持500+应用集成', '99.9%系统可用?, '毫秒级响应速度'],
    },
    {
      title: '多角色协同作?,
      description:
        '为运营、技术、业务等不同角色提供专属工作台，实现跨部门高效协作，打破信息孤岛?,
      metrics: ['3种角色模?, '实时协作编辑', '权限精细化管?],
    },
    {
      title: '智能代理服务',
      description:
    ...
    },
    {
      ...
      metrics: ['实时数据同步', '自定义报表生?, '智能预警机制'],
    },
    {
      title: '企业级安全保?,
      description:
        '端到端加密传输，完善的权限管理体系，符合企业安全合规要求，保护核心业务数据?,
      metrics: ['ISO 27001认证', '数据加密存储', '细粒度权限控?],
    },
    {
      title: '灵活部署方案',
      description:
        '支持云端SaaS和私有化部署，可根据企业需求灵活选择，确保业务连续性和数据主权?,
      metrics: ['公有?私有云双部署', '容器化一键部?, '99.95%服务承诺'],
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      question: '部署实施需要多长时间？',
      answer:
        '标准实施周期?-4周。我们提供专业的实施团队，包括需求调研、系统配置、数据迁移、员工培训等全套服务，确保顺利上线?,
    },
    {
      question: '数据安全性如何保障？',
      answer:
  ...
  return (
    <div>
      ...
      {/* Hero区域 */}
      <HeroSection
        title="一站式 n8n + 智能?企业自动化平?
        subtitle="提升50%工作效率，降?0%运营成本，让企业数字化转型变得更简?
        ctaText="免费试用"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">7×24小时技术支?/span>
                </li>
                <li className="flex items-center">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3">
                    <svg
                  ...
                  <span className="text-gray-700">无任何隐藏费?/span>
                </li>
              </ul>
            ...
            <div>
              <LeadForm
                role="overview"
                onSubmit={(data: any) => {
                  // TODO: 移除调试日志 - // TODO: 移除调试日志 - console.log('表单提交:', data)// 可以在这里添加额外的处理逻辑
                }}
              />
            </div>
          </div>
