  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">用户权限管理和安全审计</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      ...
                      <p className="font-medium">{role.userCount} 人</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">权限数</p>
            ...
            {filteredUsers.length === 0 && (
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-gray-500">调整筛选条件或添加新用户</p>
                </CardContent>
              </Card>
            )}
          </div>
        ...
        <TabsContent value="audit" className="space-y-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">用户操作和安全事件记录</p>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            用户 ID: {log.userId} IP: {log.ipAddress}
                          </p>
