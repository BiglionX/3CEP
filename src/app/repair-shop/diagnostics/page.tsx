...
export default function DiagnosticsPage() {
  ...
  const getOverallStatus = () => {
    ...
    if (failedCount === 0) return { status: 'excellent', text: '优秀', color: 'text-green-600' };
    if (failedCount <= 2) return { status: 'good', text: '良好', color: 'text-yellow-600' };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold text-gray-900">设备诊断工具</h1>
            </div>
          </div>
        </div>
      </header>
                    ...
                    {overallStatus && (
                      <>
                        ...
                        <div className="text-gray-600">
                          {testResults.filter(t => t.status === 'passed').length} 项通过，
                          {testResults.filter(t => t.status === 'failed').length} 项失败
                        </div>
                      </>
                    )}
                  </div>
                      ...
                      {testResults
                        ...
                        .map(test => (
                          <li key={test.id} className="flex items-start gap-2">
                            ...
                            <span className="text-gray-700">{test.name}: {test.result}</span>
                          </li>
                        ))
                      }
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-gray-900 mb-2">1. 输入设备信息</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-gray-900 mb-2">2. 开始诊断</h3>
                  <p className="text-sm text-gray-600">
