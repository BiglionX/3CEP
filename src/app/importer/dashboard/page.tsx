  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">进口商工作台</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* 欢迎区域 */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">欢迎回来，采购经理！</h1>
          <p className="text-gray-600">今天是 {new Date().toLocaleDateString('zh-CN')}，全球采购业务运行正常</p>
        </div>
                ...
                <div className="space-y-4">
                  {orders.map((order) => (
                    <div 
                      ...
                      onClick={() => router.push(`/importer/procurement/${order.id}`)}
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            数量: {order.quantity} | 金额: ¥{order.amount.toLocaleString()}
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-sm text-gray-500">预计交付</p>
                          <p className="font-medium">{new Date(order.expectedDelivery).toLocaleDateString('zh-CN')}</p>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">PO-2026-002 预计今日到达上海港</p>
                      <p className="text-xs text-gray-500">请及时安排清关手续</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm font-medium">Samsung 供应商询价回复截止</p>
                      <p className="text-xs text-gray-500">请在今日17:00前确认</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm font-medium">新供应商 Apple 认证审核通过</p>
                      <p className="text-xs text-gray-500">可正式开展业务合作</p>
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">美元兑人民币上涨0.3%</p>
                    </div>
                  </div>
                </div>
              </CardContent>
