      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">管理和维护您的所有电子设备</p>
          </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-2xl font-bold text-gray-900">
                    {devices.filter(d => new Date(d.warrantyEnd) > new Date()).length}
                  </p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                          ...
                          <div>
                            ...
                            <p>{new Date(device.warrantyEnd).toLocaleDateString()}</p>
                          </div>
                        </div>
                        
                        <div className="mt-3 flex items-center space-x-4 text-xs text-gray-500">
                          <span>上次维护: {new Date(device.lastMaintenance).toLocaleDateString()}</span>
                          {new Date(device.warrantyEnd) < new Date() && (
                            <span className="text-red-500">⚠️ 保修已过期</span>
                          )}
                        </div>
                      </div>
                    </div>
