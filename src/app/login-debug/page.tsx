      ...
      if (!authData.authenticated) {
        ...
        results[1] = {
          ...
          details: loginResponse.ok ? 
            `用户: ${loginData.user?.email}, 管理员: ${loginData.user?.is_admin}, 跳转目标: /admin/dashboard` :
            `错误: ${loginData.error}`
        };
        ...
        if (loginResponse.ok && loginData.user?.is_admin) {
          ...
          // 延迟跳转以便观察
          setTimeout(() => {
            console.log('执行跳转到 /admin/dashboard');
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">登录跳转调试器</h1>
