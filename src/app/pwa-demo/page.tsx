...
import { PWAManager, usePWA } from '@/components/pwa/PWAManager';
...
export default function PWADemoPage() {
  ...
  // 标记通知为已?  const markAsRead = (id: number) => {
    setNotifications(
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="features" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="features">核心特?/TabsTrigger>
            <TabsTrigger value="manager">状态管?/TabsTrigger>
          ...
          <TabsContent value="features" className="space-y-6">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span className="text-sm">无地址栏干?/span>
                    </div>
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span className="text-sm">数据预加?/span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span className="text-sm">实时消息推?/span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span className="text-sm">响应式设?/span>
                    </div>
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      <span className="text-sm">多设备数据同?/span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-500" />
            ...
            <Card>
              <CardHeader>
                <CardTitle>安装状?/CardTitle>
                <CardDescription>当前应用的安装和运行状?/CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                    <div>
                      <div className="font-medium">安装状?/div>
                      <div className="text-sm text-gray-600">
                        应用是否已安?                      </div>
                    </div>
                    <Badge variant={isInstalled ? 'default' : 'secondary'}>
                      {isInstalled ? '已安? : 'Web版本'}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                    <div>
                      <div className="font-medium">网络状?/div>
                      <div className="text-sm text-gray-600">当前连接状?/div>
                    </div>
                    <Badge variant={isOnline ? 'default' : 'destructive'}>
                      {isOnline ? '在线' : '离线'}
                    </Badge>
                ...
                <div className="space-y-6">
                  ...
                  {simulateOffline && (
                    <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                      <div className="flex items-center gap-2 text-red-800 mb-2">
                        ...
                        <span className="font-medium">离线模式已启?/span>
                      </div>
                      <p className="text-sm text-red-700">
                        现在所有的网络请求都会失败，您可以测试应用的离线功能表现?                      </p>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Button
                      ...
                      onClick={() => {
                        fetch('/api/test')
                          .then(() => // TODO: 移除调试日志 - // TODO: 移除调试日志 - console.log('API调用成功'))
                          .catch(() => // TODO: 移除调试日志 - // TODO: 移除调试日志 - console.log('API调用失败（预期）'));
                      }}
                ...
                <CardContent>
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                      <div>
                        <div className="font-medium">数据预加?/div>
                        <div className="text-sm text-gray-600">
                          重要数据在联网时预先缓存
                        </div>
                      </div>
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                      <div>
                        <div className="font-medium">渐进式加?/div>
                        <div className="text-sm text-gray-600">
                          网络恢复后自动同步数?                        </div>
                      </div>
                    </li>
