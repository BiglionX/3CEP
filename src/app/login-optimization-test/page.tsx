        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>执行各项功能测试并查看结果</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>需要验证的核心功能特性</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        {testResults.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>各项功能的验证结果</CardDescription>
            </CardHeader>
            <CardContent>
