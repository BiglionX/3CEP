      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            {is_admin && <Badge variant="destructive">管理员模式</Badge>}
          </div>
        </div>
            ...
            <Card>
              <CardHeader className="text-center">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <Badge variant="outline">{user.memberLevel}</Badge>
                  <Badge
                    variant="default"
                      ...
                      >
                        <div className="p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-md transition-all duration-200">
                          <div className="flex items-start space-x-3">
                            <div
                              className={`p-2 rounded-lg ${colorClasses[module.color as keyof typeof colorClasses]}`}
                            >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {personalizationModules.map(module => {
                    ...
                    const modulePaths: Record<string, string> = {
                      ...
                      achievement_center:
                        '/profile/personalization/achievement-center',
                      preference_settings:
                        '/profile/personalization/preference-settings',
                    };
