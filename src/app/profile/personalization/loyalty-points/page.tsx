  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">用积分兑换心仪好礼</p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xl font-bold text-gray-900">12次</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-medium text-gray-900 mb-1">{reward.name}</h3>
                      <p className="text-sm text-gray-600 mb-3">{reward.description}</p>
                      
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-2">
                          <Star className="w-4 h-4 text-yellow-500 fill-current" />
                          <span className="font-bold text-yellow-600">{reward.points}</span>
                        ...
                        <span className={`text-sm px-2 py-1 rounded-full ${
                          ...
                          {reward.stock > 0 ? `剩余${reward.stock}件` : '已售罄'}
                        </span>
                      </div>
                      ...
                      <Button
                        ...
                        disabled={pointsBalance < reward.points || reward.stock <= 0}
                      >
                        {reward.stock <= 0 ? '已售罄' : 
                         pointsBalance < reward.points ? '积分不足' : '立即兑换'}
                      </Button>
                    </div>
                  </div>
                </CardContent>
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  { action: '完成维修订单', points: '+50~200', frequency: '每单奖励' },
                  { action: '购买配件', points: '+1元=1积分', frequency: '消费返利' },
                  { action: '邀请好友', points: '+100', frequency: '每成功邀请' },
