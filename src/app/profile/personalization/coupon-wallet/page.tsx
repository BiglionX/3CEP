...
export default function CouponWalletPage() {
  ...
  const categories = ['all', '通用?, '维修?, '配件?];
  const statuses = [
    { value: 'all', label: '全部', count: coupons.length },
    { value: 'available', label: '可用', count: statusCounts.available },
    { value: 'used', label: '已使?, count: statusCounts.used },
    { value: 'expired', label: '已过?, count: statusCounts.expired },
  ];
  ...
  const getDiscountDisplay = (coupon: Coupon) => {
    switch (coupon.discountType) {
      ...
      case 'fixed':
        return `�?{coupon.minimumAmount}�?{coupon.discountValue}`;
      case 'free_shipping':
        return '免运?;
      default:
        return '';
          ...
          <CardContent className="p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-600">已使?/p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-600">已过?/p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {filteredCoupons.length === 0 && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600">调整筛选条件或获取更多优惠?/p>
          </CardContent>
        </Card>
      )}
    </div>
