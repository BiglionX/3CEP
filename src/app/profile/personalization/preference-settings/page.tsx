...
export default function PreferenceSettingsPage() {
  ...
  const [originalPreferences, setOriginalPreferences] = useState<Record<string, any>>({})
          ...
          <Card key={category.id}>
            ...
            <CardContent className="space-y-6">
              {category.settings.map(setting => (
                <div key={setting.id} className="pb-4 border-b border-gray-100 last:border-b-0 last:pb-0">
