  ...
  const preferenceCategories: PreferenceCategory[] = [
    {
      ...
      settings: [
        ...
        },
        {
          ...
          type: 'toggle',
          label: '短信通知',
          description: '紧急情况下发送短信提?,
        },
        {
          id: 'push_notifications',
          type: 'toggle',
          label: '推送通知',
          description: '在移动设备上显示推送消?,
        },
        {
      ...
      settings: [
        {
          ...
          type: 'select',
          label: '资料可见?,
          description: '控制谁可以看到您的个人资?,
          options: [
            { value: 'public', label: '公开' },
            { value: 'friends', label: '好友可见' },
            { value: 'private', label: '仅自己可? },
          ],
        },
        {
          id: 'location_sharing',
        ...
        },
        {
          ...
          type: 'toggle',
          label: '活动分享',
          description: '与其他用户分享您的活?,
        },
        {
          id: 'data_collection',
          type: 'toggle',
          label: '数据分析',
          description: '允许收集使用数据以改进服?,
        },
      ],
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          type: 'toggle',
          label: '个性化广告',
          description: '显示基于兴趣的广?,
        },
        {
          id: 'interest_categories',
          type: 'select',
          label: '兴趣类别',
          description: '选择您感兴趣的内容类?,
          options: [
            { value: 'technology', label: '科技数码' },
            { value: 'repair', label: '维修技? },
            { value: 'life', label: '生活技? },
    ...
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          type: 'select',
          label: '备份频率',
          description: '自动备份数据的频?,
          options: [
            { value: 'hourly', label: '每小? },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">自定义您的使用体?/p>
        </div>
