  ...
  const popularArticles: HelpArticle[] = [
    {
      id: 'article-1',
      title: '如何预约上门维修服务',
      excerpt: '详细介绍了预约上门维修的完整流程，包括选择服务时间、填写设备信息等步骤',
      category: '设备维修',
      views: 1256,
      likes: 89,
  ...
  const faqItems = [
    {
      ...
      answer: '一般情况下，简单维修1-2小时内完成，复杂维修需要1-3个工作日。我们会根据具体情况给出准确的时间预估。'
    },
    {
      question: '如何查询维修进度？',
      answer: '您可以通过个人中心的"我的订单"页面实时查看维修进度，也可以通过微信公众号接收进度通知。'
    },
    {
      question: '维修后有保修期吗？',
      answer: '是的，所有维修服务都提供30天质量保修期。保修期内如出现同样问题，可免费返修。'
    },
    {
      question: '支持哪些支付方式？',
    ...
    {
      question: '如何使用智能估价系统？',
      answer: '在首页或设备管理页面点击"智能估价"，按照提示输入设备信息和状况，系统将给出精准的价格评估。'
    },
    {
      question: '配件商城的商品都是正品吗？',
      answer: '是的，我们承诺所有配件均为原厂或优质兼容件，并提供质量保证。每件商品都有详细的产品说明和参数。'
    },
    {
      question: '如何申请成为服务商？',
      answer: '请前往商户合作页面提交申请，我们的商务团队会在3个工作日内与您联系，协助完成入驻流程。'
    },
    {
      question: '设备回收有什么要求？',
      answer: '接受外观完好、功能正常的二手设备回收。我们会根据设备型号、使用年限和成色给出合理报价。'
    }
  ]
