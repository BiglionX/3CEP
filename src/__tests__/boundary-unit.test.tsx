...
describe('边界情况单元测试', () => {
  ...
  describe('点赞功能测试', () => {
    test('TC-001: 点赞 3 次触发草稿创建', async () => {
      ...
      // �?次点?      fireEvent.click(screen.getByTestId('like-button'));
    ...
    test('TC-003: 快速连续点赞防抖测试', async () => {
      ...
      // 快速点?�?      await user.dblClick(screen.getByTestId('like-button'));
  ...
  describe('预约功能测试', () => {
    ...
    test('TC-011: 边界时间测试', () => {
      ...
      // 测试部分重叠的情?      fireEvent.click(screen.getByTestId('slot-1030-1130'));
