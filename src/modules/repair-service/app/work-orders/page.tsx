          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">
                ¥{workOrders.filter(o => o.status === 'completed').reduce((sum, order) => sum + order.price, 0).toLocaleString()}
              </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                          ...
                          <div>
                            <p className="text-sm text-gray-700 mb-2">{order.deviceIssue}</p>
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              <User className="h-4 w-4" />
                        ...
                        <div className="flex items-center justify-between text-sm text-gray-500">
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>预计完成: {new Date(order.estimatedCompletion).toLocaleString('zh-CN', {
                                month: 'short',
                                day: 'numeric',
                                hour: '2-digit',
                                minute: '2-digit'
