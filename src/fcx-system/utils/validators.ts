 ...
 * 验证创建FCX账户的数据
 */
export function validateCreateAccountDto(dto: CreateFcxAccountDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 验证FCX转账数据
 */
export function validateTransferDto(dto: FcxTransferDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 验证FCX购买数据
 */
export function validatePurchaseDto(dto: PurchaseFcxDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 验证质押数据
 */
export function validateStakeDto(dto: StakeFcxDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 验证创建工单数据
 */
export function validateCreateOrderDto(dto: CreateRepairOrderDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 验证完成工单数据
 */
export function validateCompleteOrderDto(dto: CompleteRepairOrderDTO): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
  ...
  if (dto.rating < ORDER_CONSTANTS.MIN_RATING || dto.rating > ORDER_CONSTANTS.MAX_RATING) {
    errors.push(`评分必须在${ORDER_CONSTANTS.MIN_RATING}-${ORDER_CONSTANTS.MAX_RATING}之间`);
  }
 ...
 * 验证评分数据
 */
export function validateRating(rating: number): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 * 批量验证多个字段
 */
export function validateMultiple(validators: Array<() => { isValid: boolean; errors: string[] }>): { 
  isValid: boolean; 
  errors: string[] 
} {
