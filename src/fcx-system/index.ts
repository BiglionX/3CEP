...
export const FCX_CONSTANTS = {
  ...
  // 质押要求
  MIN_STAKING_AMOUNT: 1000, // 最低质押1000 FCX
  MAX_STAKING_AMOUNT: 100000, // 最高质押100000 FCX

  // 奖励设置
  BASE_REWARD_PERCENTAGE: 0.1, // 基础奖励10%
  MAX_RATING_MULTIPLIER: 1.5, // 最高评分倍数1.5倍
  ...
  // 期权有效期
  OPTION_EXPIRY_DAYS: 730, // 2年有效期

  // 系统设置
  TRANSACTION_FEE: 0, // 交易手续费（暂设为0）
