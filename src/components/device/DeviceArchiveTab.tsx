...
export default function DeviceArchiveTab({
  qrcodeId,
  className = '',
}: DeviceArchiveTabProps) {
  const [activeTab, setActiveTab] = useState<
    'profile' | 'timeline' | 'history'
  >('profile');
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  >
                    {
                      DEVICE_STATUS_LABELS[
                        profile.currentStatus as DeviceStatus
                      ]
                    }
                  </span>
                      ...
                      .map(event => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            {event?.partsReplaced &&
                              event.eventData.partsReplaced.length > 0 && (
                                <div>
