...
| 模块     | 基础路径                 | 主要页面             | 访问权限   |
| -------- | ------------------------ | -------------------- | ---------- |
| 认证模块 | `/auth`                  | 登录、注册、找回密码 | 公开       |
| 维修服务 | `/repair-shop`           | 仪表板、工单、诊断   | 维修店用户 |
| B2B采购  | `/importer`, `/exporter` | 采购/销售管理        | 贸易商用户 |
| 配件商城 | `/parts`                 | 商品浏览、购物车     | 注册用户   |
| FCX联盟  | `/fcx`                   | 质押、奖励、治理     | FCX持有者  |
| 管理后台 | `/admin`                 | 系统管理功能         | 管理员     |
| 数据中心 | `/data-center`           | 数据分析功能         | 授权用户   |
