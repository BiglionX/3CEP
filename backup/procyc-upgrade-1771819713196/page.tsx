                    ...
                    <TableCell colSpan={7}>
                      <div className="p-4 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <h4 className="font-medium text-gray-900 mb-2">资质信息</h4>
                            <div className="space-y-2 text-sm">
                              <div>
                                <span className="text-gray-500">营业执照：</span>
                                <span className="font-medium">{shop.business_license || '未提供'}</span>
                              </div>
                              <div>
                                <span className="text-gray-500">资格证书：</span>
                                <span className="font-medium">{shop.qualification_cert || '未提供'}</span>
                              </div>
                            </div>
                          </div>
                        ...
                        {(shop.logo_url || shop.cover_image_url) && (
                          <div>
                            <h4 className="font-medium text-gray-900 mb-2">店铺图片</h4>
                            <div className="flex gap-4">
                              ...
                              {shop.cover_image_url && (
                                <div>
                                  <p className="text-sm text-gray-500 mb-1">门头照</p>
                                  <img 
