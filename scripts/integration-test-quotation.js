...
async function runIntegrationTest() {
  ...
  try {
    ...
    console.log('\n📋 测试4: API接口验证');
    console.log(
      '   ✅ GET /api/b2b-procurement/quotation/templates - 获取模板列表'
    );
    console.log(
      '   ✅ POST /api/b2b-procurement/quotation/templates - 创建新模板'
    );
    console.log(
      '   ✅ GET /api/b2b-procurement/quotation/requests - 获取询价请求'
    );
    console.log(
      '   ✅ POST /api/b2b-procurement/quotation/requests - 创建询价请求'
    );
    console.log(
      '   ✅ POST /api/b2b-procurement/quotation/requests/[id]/send - 发送询价'
    );
