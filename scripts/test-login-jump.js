...
if (fs.existsSync(loginPagePath)) {
  ...
  // 检查是否包含正确的跳转逻辑
  const hasCorrectJumpLogic = content.includes('const targetRedirect = redirect?.startsWith(\'/admin\') ? redirect : \'/admin/dashboard\'');
...
const googleButtonPath = path.join(process.cwd(), 'src', 'components', 'GoogleLoginButton.tsx');
