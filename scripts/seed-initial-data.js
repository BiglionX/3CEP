...
async function seedPartsLibrary(client) {
  ...
  const additionalParts = [
    ...
    // 摄像头类
    {
      name: 'iPhone 14 Pro 后置摄像头模组',
      category: '摄像头',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: '华为Mate 60 Pro 后置摄像头',
      category: '摄像头',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
    ...
    // 外壳保护类
    {
      name: 'iPhone 14 Pro 硅胶保护壳',
      category: '外壳',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: '华为Mate 60 Pro 皮革保护套',
      category: '外壳',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
    ...
    // 排线类
    {
      name: 'iPhone 14 Pro 屏幕排线',
      category: '排线',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: 'iPhone 14 Pro 电池排线',
      category: '排线',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: '华为Mate 60 Pro 屏幕排线',
      category: '排线',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
    {
      name: '华为Mate 60 Pro 充电排线',
      category: '排线',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
    ...
    // 扬声器类
    {
      name: 'iPhone 14 Pro 外放扬声器',
      category: '音频',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: 'iPhone 14 Pro 听筒',
      category: '音频',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: '华为Mate 60 Pro 扬声器',
      category: '音频',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
    ...
    // 按键类
    {
      name: 'iPhone 14 Pro 音量键',
      category: '按键',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: 'iPhone 14 Pro 电源键',
      category: '按键',
      brand: 'Apple',
      model: 'iPhone 14 Pro',
    },
    {
      name: '华为Mate 60 Pro 音量键',
      category: '按键',
      brand: '华为',
      model: 'Mate 60 Pro',
    },
  ...
  for (const part of partsResult.rows) {
    const category =
      Object.keys(basePrices).find(cat => part.name.includes(cat)) || '其他';
    const [minPrice, maxPrice] = basePrices[category] || [100, 500];

    for (const platform of platforms) {
      // 生成合理的价格差异
      const priceMultiplier =
        platform === '淘宝' ? 1.0 : platform === '京东' ? 1.1 : 0.9;
      const price = Math.round(
        (Math.random() * (maxPrice - minPrice) + minPrice) * priceMultiplier
      );
      ...
      `,
        [
          ...
          platform,
          price,
          `https://${platform.toLowerCase()}.com/search?q=${encodeURIComponent(part.name)}`,
        ]
      );
    }
  }
  ...
  console.log(
    `✅ 配件库数据填充完成 (${partsResult.rows.length} 个配件，每个3个平台价格)`
  );
}
...
async function verifyDataIntegrity(client) {
  ...
  for (const table of tables) {
    ...
    console.log(
      `${status} ${table.name}: ${count} 条记录 (最低要求: ${table.minCount})`
    );
  }
}
