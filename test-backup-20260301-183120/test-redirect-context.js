...
if (fs.existsSync(unifiedLoginPath)) {
  ...
  const hasRedirectInfoComponent =
...
const overallCompletion = Math.round(
  (fixesCompleted.length / (fixesCompleted.length + fixesNeeded.length)) * 100
);
...
console.log(
  '2. 管理后台: http://localhost:3000/login?redirect=/admin/dashboard'
);
console.log(
  '3. 品牌商平台: http://localhost:3000/login?redirect=/brand/products'
);
