...
export const TEST_CONFIG = {
  ...
  TEST_DATA: {
    ...
    faultTypes: [
      { name: '屏幕损坏', code: 'screen_broken', description: '屏幕碎裂或显示异常' },
      { name: '电池问题', code: 'battery_issue', description: '电池不耐用或无法充电' },
      { name: '进水故障', code: 'water_damage', description: '设备进水导致功能异常' },
      { name: '无法开机', code: 'power_issue', description: '设备无法正常启动' },
      { name: '声音问题', code: 'audio_issue', description: '听筒、扬声器无声或杂音' }
    ],
