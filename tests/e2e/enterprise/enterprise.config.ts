...
export const ENTERPRISE_TEST_CONFIG = {
  ...
  getBaseUrl(): string {
    return (
      this.urls[this.defaultEnv as keyof typeof this.urls] || this.urls.test
    );
  },
...
export const PERMISSIONS = {
  ...
  // 普通用户权限
  user: ['enterprise_read', 'enterprise_basic_access'],
};
...
export const SECURITY_TEST_CONFIG = {
  ...
  // 恶意文件上传测试
  maliciousFiles: ['malicious.php', 'virus.exe', 'shell.jsp'],
};
