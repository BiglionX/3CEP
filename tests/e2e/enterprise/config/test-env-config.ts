...
export const ENVIRONMENT_CONFIG = {
  ...
  production: {
    ...
    API_BASE_URL:
      process.env.PROD_API_BASE_URL || 'https://your-domain.com/api',
...
export const CURRENT_CONFIG =
  ENVIRONMENT_CONFIG[CURRENT_ENV as keyof typeof ENVIRONMENT_CONFIG];
...
export const PERFORMANCE_CONFIG = {
  ...
  COLLECT_PERFORMANCE_METRICS:
    process.env.COLLECT_PERFORMANCE_METRICS === 'true',
