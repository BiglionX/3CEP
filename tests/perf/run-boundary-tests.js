...
Object.entries(testResults).forEach(([module, stats]) => {
  console.log(
    `│ ${module.padEnd(13)} │ ${String(stats.total).padEnd(5)} │ ${String(stats.passed).padEnd(5)} │ ${String(stats.failed).padEnd(5)} │ ${stats.coverage.padEnd(8)} │`
  );
});
