-- Simplified Unified Link Library Table Creation Script
-- This version removes dependencies on admin_users table
...
-- Create simplified security policies (without admin_users dependency)
...
-- Migrate data from hot_links table
...
-- Migrate data from hot_link_pool table (higher priority)
INSERT INTO unified_link_library (
  url, title, description, source, category, sub_category,
...
-- Set initial priorities for existing links
